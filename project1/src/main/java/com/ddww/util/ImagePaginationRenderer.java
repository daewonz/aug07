...
public class ImagePaginationRenderer extends AbstractPaginationRenderer {
	...
	public ImagePaginationRenderer() {
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\"><image src=\"./img/left2.png\" border=0/></a>&#160;"; 
		...
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\"><image src=\"./img/right2.png\" border=0/></a>&#160;";
	}
}